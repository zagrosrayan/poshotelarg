...
return [
    ...
    */
    ...
    'exists' => 'گزینه انتخاب شده :attribute موجود نمی باشد',
    ...
    */
    'custom' => [
        'mobile' => [
            'regex'    => 'شماره موبایل باید با 09 شروع شده و شامل 11 رقم باشد.',
        ],
        'username' => [
            'regex'    => 'نام کاربری باید فقط شامل حروف انگلیسی، اعداد، نقطه و زیرخط باشد.',
        ],
        'full_name' => [
            'regex'    => 'نام و نام خانوادگی باید فقط شامل حروف فارسی، عربی و انگلیسی باشد.',
        ],
        'password' => [
            'regex'    => 'رمز عبور باید حداقل شامل ۸ کاراکتر باشد.',
        ],
        'image' => [
            'max' => 'حجم تصویر نباید بیشتر از 2 مگابایت باشد.',
            'file' => 'فایل باید از نوع تصویر باشد.',
        ],
        'name' => [
            'min' => 'نام باید حداقل 3 کاراکتر باشد.',
            'max' => 'نام نمی‌تواند بیشتر از 255 کاراکتر باشد.',
        ],
        'address' => [
            'max' => 'آدرس نمی‌تواند بیشتر از 500 کاراکتر باشد.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'discountable_type' => 'نوع قابل تخفیف',
        'discountable_id' => 'شناسه قابل تخفیف',
        'user_id' => 'شناسه کاربر',
        'customer_id' => 'شناسه مشتری',
        'status_id' => 'شناسه وضعیت',
        'parent_id' => 'شناسه والد',
        'discount_id' => 'شناسه تخفیف',
        'product_meta_data_id' => 'شناسه داده‌های متا محصول',
        'count' => 'تعداد',
        'discounted_price' => 'قیمت تخفیف‌خورده',
        'payment_payable' => 'مبلغ قابل پرداخت',
        'discounted' => 'تخفیف‌دار',
        'seller' => 'فروشنده',
        'message' => 'پیام',
        'factor_date' => 'تاریخ فاکتور',
        'factor_payment' => 'پرداخت فاکتور',
        'publishing' => 'انتشارات',
        'collection' => 'مجموعه',
        'grade_id' => 'شناسه مقطع',
        ...
        'warehouse_status' => 'وضعیت انبار',
        'category' => 'دسته‌بندی',
        'slug' => 'اسلاگ',
        'remember_token' => 'توکن به یادآوری',
        'status_slug' => 'وضعیت انتشار',
        'factor.0.product_meta_data_id' => 'محصول',
        'factor.0.price' => 'قیمت با تخفیف',
        'reserve_number' => 'شماره رزرو',
        'room_service' => ' داخل اتاق',
        'service_type' => 'نوع سرویس',
        'room_number' => 'شماره اتاق',
        'dine_in' => 'داخل رستوران',
        'role_id' => 'شناسه نقش',
        'role_ids' => 'شناسه‌های نقش',
        'route_ids' => 'شناسه‌های مسیر',
        'route_name' => 'نام مسیر',
        'display_name' => 'نام نمایشی',
        'is_menu' => 'نمایش در منو',
        'uri' => 'آدرس مسیر',
        'old_password' => 'رمز عبور قبلی',
        'campaign_id' => 'شناسه کمپین',
        'customers' => 'مشتریان',
        'customers.*.id' => 'شناسه مشتری',
        'category_id' => 'شناسه دسته‌بندی',
        'remove_image' => 'حذف تصویر',
        'is_activated' => 'وضعیت فعال‌سازی',
        'no_orders' => 'بدون سفارش',
        'recently_registered' => 'ثبت‌نام اخیر',
        'inactive_orders' => 'سفارشات غیرفعال',
        'paginate' => 'تعداد در صفحه',
        'export' => 'خروجی',
        'summary' => 'خلاصه',
        'starts_at' => 'تاریخ شروع',
        'expires_at' => 'تاریخ پایان',
        'profit_manager_id' => 'شناسه مرکز درامد',
        'code' => 'کد تخفیف',
        'is_unlimited' => 'نامحدود',
        'minimum_purchase_amount' => 'حداقل مبلغ خرید',
        'discount_percentage' => 'درصد خرید',
        'apply_on_orders_above' => 'سفارش های بالای',
        'usage_limit' => 'تعداد قابل استفاده',
        'minimum_price' => 'حداقل مبلغ',
        'points_per_purchase' => 'تعداد امتیاز',
        'amount_per_point' => 'مبلغ خرید به ازای هر امتیاز',
        'points_per_discount' => 'تعداد امتیاز برای تخفیف',
        'discount_amount_per_point' => 'مبلغ تخفیف به ازای هر امتیاز',
        'reminder_days_before_expiration' => 'تعداد روز یادآوری قبل از انقضا',
        'discount_validity_days' => 'مدت اعتبار تخفیف (روز)',
        'discount_sms_template' => 'متن پیامک تخفیف',
        'reminder_sms_template' => 'متن پیامک یادآوری',
        'customer_mobile' => 'شماره موبایل کاربر',
        'profit_manager_ids' => 'مراکز درآمد',
        'target_customer_types' => 'نوع مشتریان هدف',
    ],
    'other' => [
        'room_service' => 'داخل اتاق'
    ],
